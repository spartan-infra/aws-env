...
inputs = {
  ...
  db_vpc_subnet_group_name   = dependency.networking.outputs.vpc_database_subnet_group_name
  ...
  db_replica_instance_type   = local.replica_instance_type
  db_replica_count           = local.instance_count
}